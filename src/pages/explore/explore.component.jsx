                    ...
                    <Accordion sx={{ background: 'rgb(255 210 217)' }}>
                        <AccordionSummary
                            ...
                            <div className='card-content'>
                                <p style = {{backgroundColor: 'rgb(250, 190, 199)', fontWeight: '600'}}>tag: diabetes</p>
                                <h3>Dumbell Bicep Curl</h3>
                                <h6>A lifestyle therapy for prevention and treatment of diabetes.</h6>
                            </div>
                ...
                <div className='card diabetes-lunges'>
                    <Accordion sx={{ background: '#faf3b3' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#f2e893', fontWeight: '600'}}>tag: diabetes</p>
                                <h3>Lunges</h3>
                                <h6>A lifestyle therapy for prevention and treatment of diabetes.</h6>
                            </div>
                            <div className='card-image'>
                ...
                <div className='card diabetes-sidekick'>
                    <Accordion sx={{ background: '#afc3ff' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#94afff', fontWeight: '600'}}>tag: diabetes</p>
                                <h3>Side Kick</h3>
                                <h6>A lifestyle therapy for prevention and treatment of diabetes.</h6>
                            </div>
                            <div className='card-image'>
                ...
                <div className='card elbow-flexion'>
                    <Accordion sx={{ background: '#faf3b3' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#f2e893', fontWeight: '600'}}>tag: Elbow</p>
                                <h3>Elbow Flexion</h3>
                                <h6>Swelling, stiffness and hindered motion after fracture/ burns. </h6>
                            </div>
                            <div className='card-image'>
                                <img className='img' src={Workout} alt='image' />
                            </div>
                ...
                <div className='card elbowShoulder-elevation'>
                    <Accordion sx={{ background: '#afc3ff' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#94afff', fontWeight: '600'}}>tag: Elbow</p>
                                <h3>Shoulder Elevation</h3>
                                <h6>Stiffness and hindered motion of shoulder after elbow fracture.</h6>
                            </div>
                            <div className='card-image'>
                                <img className='img' src={Workout} alt='image' />
                            </div>
                ...
                <div className='card knee-extension'>
                    <Accordion sx={{ background: 'rgb(255 210 217)' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: 'rgb(250, 190, 199)', fontWeight: '600'}}>tag: Knee</p>
                                <h3>Knee Extension</h3>
                                <h6>Stiffness and hindered motion after fracture/ burns in knee joint.</h6>
                            </div>
                            <div className='card-image'>
                                <img className='img' src={Workout} alt='image' />
                            </div>
                ...
                <div className='card shoulder-abduction'>
                    <Accordion sx={{ background: '#faf3b3' }}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#f2e893', fontWeight: '600'}}>tag: Shoulder</p>
                                <h3>Shoulder Abduction</h3>
                                <h6>Characterized by pain and stiffness in the shoulder joint. </h6>
                            </div>
                            <div className='card-image'>
                                <img className='img' src={Workout} alt='image' />
                            </div>
                ...
                <div className='card shoulder-flexion'>
                    <Accordion sx={{ background: '#afc3ff'}}>
                        <AccordionSummary
                            ...
                            id="panel1a-header">
                            <div className='card-content'>
                                <p style = {{backgroundColor: '#94afff', fontWeight: '600'}}>tag: Shoulder</p>
