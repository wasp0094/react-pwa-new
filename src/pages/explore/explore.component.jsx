            ...
            <div className="card diabetes-lunges">
              <Accordion sx={{ background: "#faf3b3" }}>
                ...
                >
                  ...
                  <div className="card-image">
                    <img className="img lunges" src={lunges} alt="image" />
                  </div>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography
            ...
            <div className="card diabetes-sidekick">
              <Accordion sx={{ background: "#afc3ff" }}>
                ...
                >
                  ...
                  <div className="card-image">
                    <img className="img sideKick" src={sideKick} alt="image" />
                  </div>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography
            ...
            <div className="card diabetes-squats">
              <Accordion sx={{ background: "rgb(255 210 217)" }}>
                ...
                >
                  ...
                  <div className="card-image">
                    <img className="img squats" src={squats} alt="image" />
                  </div>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography
            ...
            <div className="card elbowShoulder-elevation">
              <Accordion sx={{ background: "#afc3ff" }}>
                ...
                >
                  ...
                  <div className="card-image">
                    <img
                      className="img shoulderElevation"
                      src={shoulderElevation}
                      alt="image"
                    />
                  </div>
                </AccordionSummary>
            ...
            <div className="card shoulder-abduction">
              <Accordion sx={{ background: "#faf3b3" }}>
                ...
                >
                  ...
                  <div className="card-image">
                    <img
                      className="img shoulderAbduction"
                      src={shoulderAbduction}
                      alt="image"
                    />
                  </div>
                </AccordionSummary>
